...
import { Trash2, RotateCcw, Box, Settings2 } from "lucide-react";
...
export default function ActiveModulePanel() {
  ...
  return (
    <div className="absolute top-24 left-4 z-20 w-64 bg-[#181a1d]/95 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl p-3 flex flex-col gap-3 text-sand">
