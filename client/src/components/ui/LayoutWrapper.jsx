  ...
  return (
    <>
      ...
      <main className={!isAdmin ? "pt-[76px] h-screen flex flex-col bg-transparent overflow-hidden" : "min-h-screen"}>
        <div id="main-scroll-container" className={!isAdmin ? "flex-1 w-full bg-obsidian rounded-t-[2.5rem] overflow-y-auto overflow-x-hidden shadow-[0_-10px_40px_rgba(0,0,0,0.1)] relative" : ""}>
          {children}
        </div>
      </main>
